          ...
          color: Colors.white,
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value)
                          ...
                          items: vehicules.isNotEmpty ? vehicules.map(( dynamic vehicule) {
                      ...
                      Container(
                         decoration: BoxDecoration(
                          ...
                          items: remorques.isNotEmpty ? remorques.map((dynamic remorque) {
                            return DropdownMenuItem<String>(
                              value: remorque,
                              child: Text(remorque),
                            );
...
DropType(
  onTypeChanged: (type) {
    ...
    // Après la sélection du type, vous pouvez mettre à jour les versions en fonction du titre et du type sélectionnés
    // Si vous voulez que DropVersion se mette à jour automatiquement à chaque fois que le type change, vous pouvez appeler setState ici
  },
),
SizedBox(height: 24),
Text(
      ...
      selectedVersion = version;
                      ...
                      Container(
                         decoration: BoxDecoration(
                          ...
                          items: mecanicienNames .isNotEmpty ? mecanicienNames.map((dynamic mecanicienName) {
                            return DropdownMenuItem<String>(
