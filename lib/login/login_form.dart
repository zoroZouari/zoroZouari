              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFieldAndTitle(
                    helperText:
                        'Password must have at least 1 uppercase Letter and at least 1 lower case, 1 number and 1 special char',
                    ...
                    suffixIcon: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color:
                              isHiddenPassword ? Colors.black : Colors.red,
                        )),
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Padding(
                            padding:
                                const EdgeInsetsDirectional.fromSTEB(0, 0, 0, 65),
                            child: Checkbox(
                        ...
                        onTap: () async {
                          if (keyForm.currentState!.validate()) {
                            ...
                            final authenticatedUser =
                                await UtilisateurApi.authenticate(utilisateur);

                            if (authenticatedUser != null) {
                              print(authenticatedUser);
                              switch (authenticatedUser.codeDroit) {
                                case 1:
                                  Navigator.pushNamed(
                                      context, AppRoutes.menuAdmin, arguments: authenticatedUser);
                                  break;
                                case 2:
                                  Navigator.pushNamed(
                                      context, AppRoutes.menuchefdeparc, arguments: authenticatedUser);
                                  break;
                                case 3:
                                  Navigator.pushNamed(
                                      context, AppRoutes.menuChauffeur, arguments: authenticatedUser);
                                  break;
                                case 4:
                                  Navigator.pushNamed(
                                      context, AppRoutes.mec_mission, arguments: authenticatedUser);
                                  break;
                                default:
                                  showDialog(
                                    context: context,
                                    builder: (context) => AlertDialog(
                                      title: Text('Erreur'),
                                      content: Text('Droit utilisateur inconnu.'),
                                      actions: <Widget>[
                                        TextButton(
                                          onPressed: () {
